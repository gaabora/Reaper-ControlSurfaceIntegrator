...
const english = {
    ...
    "legacy.conflict.choose": "Target already exists - choose an action",
    ...
    "legacy.conflict.unresolved": "Target already exists: {target}. Choose Replace, Import under another name, or Skip.",
