...
using SendReceiveBase = std::conditional_t<Dir == SendDirection::Send,
                                            TrackSendAction,
                                            TrackReceiveAction>;
...
public:
    ...
    {
        return Dir == SendDirection::Send ? ActionType::TrackSendVolume
                                         : ActionType::TrackReceiveVolume;
    }
...
public:
    ActionType GetType() const override
    {
        return Dir == SendDirection::Send ? ActionType::TrackSendVolumeDB
                                         : ActionType::TrackReceiveVolumeDB;
    }
...
public:
    ActionType GetType() const override
    {
        return Dir == SendDirection::Send ? ActionType::TrackSendPan
                                         : ActionType::TrackReceivePan;
    }
...
public:
    ActionType GetType() const override
    {
        return Dir == SendDirection::Send ? ActionType::TrackSendPanPercent
                                         : ActionType::TrackReceivePanPercent;
    }
...
public:
    ActionType GetType() const override
    {
        return Dir == SendDirection::Send ? ActionType::TrackSendMute
                                         : ActionType::TrackReceiveMute;
    }
...
public:
    ActionType GetType() const override
    {
        return Dir == SendDirection::Send ? ActionType::TrackSendInvertPolarity
                                         : ActionType::TrackReceiveInvertPolarity;
    }
...
public:
    ActionType GetType() const override
    {
        return Dir == SendDirection::Send ? ActionType::TrackSendStereoMonoToggle
                                         : ActionType::TrackReceiveStereoMonoToggle;
    }
...
public:
    ActionType GetType() const override
    {
        return Dir == SendDirection::Send ? ActionType::TrackSendPrePost
                                         : ActionType::TrackReceivePrePost;
    }
...
{
    static constexpr int Cat     = Dir == SendDirection::Send ? 0     : -1;
    static constexpr const char *TrackKey =
                                Dir == SendDirection::Send ? "P_DESTTRACK" : "P_SRCTRACK";
public:
    ActionType GetType() const override
    {
        return Dir == SendDirection::Send ? ActionType::TrackSendNameDisplay
                                         : ActionType::TrackReceiveNameDisplay;
    }
...
public:
    ActionType GetType() const override
    {
        return Dir == SendDirection::Send ? ActionType::TrackSendVolumeDisplay
                                         : ActionType::TrackReceiveVolumeDisplay;
    }
    ...
    virtual void RequestUpdate(ActionContext *context) override
    {
        if (MediaTrack *track = context->GetTrack())
        {
            MediaTrack *linkedTrack = (MediaTrack *)GetSetTrackSendInfo(track, Cat, context->GetSlotIndex(),
                                        Dir == SendDirection::Send ? "P_DESTTRACK" : "P_SRCTRACK", 0);
            if (linkedTrack)
            {
                char buf[128];
                if constexpr (Dir == SendDirection::Send)
...
public:
    ActionType GetType() const override
    {
        return Dir == SendDirection::Send ? ActionType::TrackSendPanDisplay
                                         : ActionType::TrackReceivePanDisplay;
    }
...
public:
    ActionType GetType() const override
    {
        return Dir == SendDirection::Send ? ActionType::TrackSendStereoMonoDisplay
                                         : ActionType::TrackReceiveStereoMonoDisplay;
    }
        ...
        if (MediaTrack *track = context->GetTrack())
        {
            ...
            if (linkedTrack)
            {
                context->UpdateWidgetValue(
                    GetTrackSendInfo_Value(track, Cat, context->GetSlotIndex(), "B_MONO") ? "mono" : "stereo");
            }
            else
                context->ClearWidget();
        }
...
public:
    ActionType GetType() const override
    {
        return Dir == SendDirection::Send ? ActionType::TrackSendPrePostDisplay
                                         : ActionType::TrackReceivePrePostDisplay;
    }
