#pragma once
// page_interface.h — IPageContext: pure-virtual interface for what ControlSurface and Navigator need from their owning Page context.
// Introducing this breaks the header-level circular dependency: control_surface.h / navigator.h only need this thin header, not the full page.h (which #includes control_surface.h).
