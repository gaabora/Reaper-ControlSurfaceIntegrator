#pragma once
//
//  fb_generic.h — Generic/protocol-agnostic MIDI feedback processors:
//    TwoState, Fader14Bit, FaderportClassicFader14Bit, Fader7Bit, Encoder,
//    ConsoleOneVUMeter, ConsoleOneGainReductionMeter, MFT_RGB.
//
