#pragma once
//
//  fb_mcu.h — MCU-protocol feedback processors:
//    MCUVUMeter, MCUDisplay, FB_MCU_AssignmentDisplay, MCU_TimeDisplay.
...
public:
    ...
    int GetMidiValue(const PropertyList& properties, double value)
    {
        ...
        else if (STRICASECMP(meterMode, "MCU") == 0)
        {
            ...
            if (midiValue > 0x0e) midiValue = 0x0e;
        }
...
public:
    ...
    virtual void SetValue(const PropertyList &properties, double value) override
    {
        ...
        if (tmode == 3) // seconds
        {
            ...
            else memcpy(bla+sizeof(bla)-strlen(buf), buf, strlen(buf));
        }
        ...
        else if (tmode > 0)
        {
            ...
            if (nm >= 100) bla[0] = '0' + (nm/100)%10;
            if (nm >= 10)  bla[1] = '0' + (nm/10)%10;
            bla[2] = '0' + (nm)%10;
            
            int nb = (pp < 0.0 ? currentTimeSignatureNumerator : 0) + (int)nbeats + 1;
            if (nb >= 10) bla[3] = '0' + (nb/10)%10;
            bla[4] = '0' + (nb)%10;
        ...
        else
        {
            ...
            if (ipp >= 360000) bla[0] = '0' + (ipp/360000)%10;
            if (ipp >= 36000)  bla[1] = '0' + (ipp/36000)%10;
            if (ipp >= 3600)   bla[2] = '0' + (ipp/3600)%10;
            bla[3] = '0' + (ipp/600)%6;
            bla[4] = '0' + (ipp/60)%10;
            bla[5] = '0' + (ipp/10)%6;
            bla[6] = '0' + (ipp%10);
