...
- Report a Zone binding or Modifier declaration that references a missing Surface Widget as a warning, skip only that binding, and continue loading the valid bindings.
