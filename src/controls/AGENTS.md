...
- Reject OSK Apply Live and Save for a standard Modifier declaration until the OSK edit protocol preserves its declaration type and mode. Never serialize it as a normal action binding.
