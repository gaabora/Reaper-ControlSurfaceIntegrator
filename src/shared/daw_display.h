...
//
//  ShowOSD is defined in daw_display.cpp so the function-local static variables
//  (lastValue, lastUpdateTs) are true per-process singletons rather than
//  per-translation-unit copies that would result from an inline header definition.
//
