...
namespace DAW
{
    ...
    inline void SendCommandMessage(WPARAM wparam)
    {
        ::SendMessage(g_hwnd, WM_COMMAND, wparam, 0);
    }

    inline bool ValidateTrackPtr(MediaTrack *track)
    {
        return ::ValidatePtr(track, "MediaTrack*");
    }

    inline bool CanUndo()
    {
        return ::Undo_CanUndo2(NULL) != nullptr;
    }

    inline bool CanRedo()
    {
        return ::Undo_CanRedo2(NULL) != nullptr;
    }
