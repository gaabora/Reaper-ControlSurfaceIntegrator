...
```
REAPER/
├── CSI.ini                      # Main plugin config
├── CSI/
│   ├── CSI.ini                  # Alternative location
│   ├── Zones/                   # Zone definitions
│   ├── FXZones/                 # FX zone definitions
│   ├── Surfaces/                # Surface templates
│   └── AutoGeneratedFXZones/    # Learn mode output
└── UserPlugins/
