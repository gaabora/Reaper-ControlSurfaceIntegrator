...
- `osk_data.lua`, `osk_render.lua`, `osk_config.lua`, `osd_ui.lua`, `ui_components.lua`, `script_host.lua`, `action_line.lua`, `layout_parser.lua`, and `label_replacements.lua` shared modules.
