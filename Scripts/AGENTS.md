...
- Do not show request, error, or runtime status text at the top of Devices. The shared footer owns operation status. Do not show an expected inactive runtime warning inside a new or edited Surface assignment form.
