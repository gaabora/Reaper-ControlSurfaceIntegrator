...
return {
    ...
    notificationsActionId = RequireValue("PRODUCT_NOTIFICATIONS_ACTION_ID"),
    notificationsScriptFilename = RequireValue("PRODUCT_NOTIFICATIONS_SCRIPT_FILENAME"),
